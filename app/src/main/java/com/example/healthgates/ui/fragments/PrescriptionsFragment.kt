...
import com.example.healthgates.ui.adapter.*
import com.example.healthgates.ui.interfaces.PopupListener
import com.example.healthgates.utils.*


class PrescriptionsFragment : BaseFragment<FragmentLabTestsBinding, PatientViewModel>(), ApiListener,
    PrescriptionInterface, PopupListener {
    ...
    private var list: ArrayList<Prescription> = ArrayList()
    ...
    override fun setupTheme() {
        ...
        lifecycleScope.launch(Dispatchers.Main) {
            ...
            labTestMode = viewModel.getLabTestMode()!!
                viewModel.getAllPrescriptions(userId, this@PrescriptionsFragment)
        }

        prescriptionAdapter = PrescriptionAdapter(requireContext(),this)
    ...
    override fun onViewClick(prescription: Prescription) {
//        navController.navigate(R.id.action_homeFragment_to_bookAppointmentDateFragment)
        downloadUrl = prescription.report
    ...
    override fun onSuccess(response: JSONObject) {
        ...
        if (response.has("result")) {
            if (response.get("result") is JSONArray) {
                ...
                val type = object : TypeToken<ArrayList<Prescription>>() {}.type
