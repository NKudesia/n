...
class DownloadFileFromURLTask(val mContext: Context, private val downloadUrl: String, private val outputDir: String, private val downloadListener: DownloadListener) : AsyncTask<String?, Int?, Boolean>() {
    private var progressDialog: ProgressDialog? = null
    private val TAG = javaClass.simpleName
    var dateFormat = SimpleDateFormat("yyyyMMdd_HHmmss")
...
//        progressDialog!!.setTitle("Downloading")
        ...
        srcURL = downloadUrl
        fileName = "report" + dateFormat.format(Date()) +".pdf"
